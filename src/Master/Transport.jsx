...
const ShowModel = ({ id, close, change }) => {
  ...
  const getolddata = async () => {
    // const datas = await getDoc(doc(TransportRef, id));
    // setOldName(datas.data().Transport);
    // setOldSName(datas.data().ShortNm);
  };
    ...
    <>
      ...
      <div class="model-boxs">
        ...
        <div class="input-wrapper mt-2 mt-lg-0  ">
          <input type="text" id="input" class="form-inp p-3" required disabled  />
          <label for="input" class="form-lab">Old Transport Name</label>
        </div>
        <div class="input-wrapper mt-3 mt-lg-0">
          <input type="text" id="input" class="form-inp p-3" required disabled/>
          <label for="input" class="form-lab">Old Short Name</label>
        </div>
      </div>
      <div class="d-lg-flex mt-lg-3">
        <div class="input-wrapper mt-3 mt-lg-0">
          <input type="text" id="input" class="form-inp p-3" required />
          <label for="input" class="form-lab">New Transport Name</label>
        </div>
        <div class="input-wrapper mt-3 mt-lg-0">
          <input type="text" id="input" class="form-inp p-3" required />
          <label for="input" class="form-lab">New Short Name</label>
        </div>
      </div>
