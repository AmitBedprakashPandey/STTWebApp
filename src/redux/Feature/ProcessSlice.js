...
const ref = collection(DB, "Process");
...
export const ProcessDetails = createSlice({
  name: "Proccess",
  initialState: {
    Proccess: [],
    loading: false,
  ...
  extraReducers: {
    ...
    [Create.fulfilled]: (state, action) => {
      state.loading = false;
      state.Proccess.push(action.payload)
    },
...
export default ProcessDetails.reducer;

export const { searchCity } = ProcessDetails.actions;
